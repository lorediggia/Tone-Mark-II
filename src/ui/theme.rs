...
pub mod col {
    ...
    fn pack(c: Color32) -> u32 { ((c.r() as u32) << 16) | ((c.g() as u32) << 8) | (c.b() as u32) }
    
    pub fn accent() -> Color32    { unpack(ACCENT_RGB.load(Ordering::Relaxed)) }
    pub fn accent_hi() -> Color32 { unpack(ACCENT_HI_RGB.load(Ordering::Relaxed)) }
...
pub enum PaletteId { Amber, Cyan, Crimson, Lime, Violet, Pink }

impl PaletteId {
    pub const ALL: [PaletteId; 6] = [
        Self::Amber, Self::Cyan, Self::Crimson, Self::Lime, Self::Violet, Self::Pink,
    ];
    
    pub fn id(self) -> &'static str {
        match self {
            Self::Amber => "amber", Self::Cyan => "cyan", Self::Crimson => "crimson",
            Self::Lime  => "lime",  Self::Violet => "violet", Self::Pink => "pink",
        }
    }
    
    pub fn from_id(s: &str) -> PaletteId {
        match s {
            "cyan" => Self::Cyan, "crimson" => Self::Crimson, "lime" => Self::Lime,
            "violet" => Self::Violet, "pink" => Self::Pink, _ => Self::Amber,
        }
    }
    
    pub fn pair(self) -> (Color32, Color32) {
        match self {
            Self::Amber   => (Color32::from_rgb(232, 122,  38), Color32::from_rgb(255, 150,  60)),
            Self::Cyan    => (Color32::from_rgb( 56, 200, 224), Color32::from_rgb(110, 225, 245)),
            Self::Crimson => (Color32::from_rgb(225,  70,  85), Color32::from_rgb(250, 105, 120)),
            Self::Lime    => (Color32::from_rgb(150, 210,  90), Color32::from_rgb(180, 235, 120)),
            Self::Violet  => (Color32::from_rgb(180, 110, 240), Color32::from_rgb(210, 150, 255)),
            Self::Pink    => (Color32::from_rgb(240, 110, 180), Color32::from_rgb(255, 150, 205)),
        }
    }
